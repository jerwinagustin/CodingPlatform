...
# Database - Using SQLite for now (MongoDB integration without djongo)
# We'll use pymongo directly in models for MongoDB operations
DATABASES = {
    'default': {
...
REST_FRAMEWORK = {
    ...
    # No default authentication - we handle it manually in views
    # 'DEFAULT_AUTHENTICATION_CLASSES': (
    #     'rest_framework_simplejwt.authentication.JWTAuthentication',
    # ),
    # Removed default permission class - using per-view decorators instead
